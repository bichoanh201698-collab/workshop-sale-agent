...
**Chipset (client edit):** Sản phẩm · Giá · Tình trạng hàng · Chính sách · **Quy trình tư vấn**
*"Lúc nào cần chuyển cho chủ shop" was removed and "Cách nói chuyện" became "Quy trình tư vấn". With five chips instead of six, space-between left wildly uneven gaps, so the chips now carry a minimum width.*
